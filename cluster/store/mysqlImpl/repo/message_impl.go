...
func voToPoWill(id string, message *messagev2.PublishMessage) po.Will {
	m := voToPo(id, message)
	return po.Will{
		ClientId:        m.ClientId,
...
func voToPoRetain(id string, message *messagev2.PublishMessage) po.Retain {
	m := voToPo(id, message)
	return po.Retain{
		Mtypeflags:      m.Mtypeflags,
		Topic:           m.Topic,
...
func voToPoInflow(id string, message *messagev2.PublishMessage) po.Inflow {
	return po.Inflow(voToPo(id, message))
}
func voToPoOutflow(id string, message *messagev2.PublishMessage) po.Outflow {
	return po.Outflow(voToPo(id, message))
}
func voToPoOffline(id string, message *messagev2.PublishMessage) po.Offline {
	return po.Offline(voToPo(id, message))
}
func poToVoWill(message po.Will) *messagev2.PublishMessage {
...
func poToVoRetain(message po.Retain) *messagev2.PublishMessage {
	return poToVo(po.Message{
		Mtypeflags:      message.Mtypeflags,
		Topic:           message.Topic,
		Qos:             message.Qos,
...
func poToVoInflow(message po.Inflow) *messagev2.PublishMessage {
	return poToVo(po.Message(message))
}
func poToVoOutflow(message po.Outflow) *messagev2.PublishMessage {
	return poToVo(po.Message(message))
}
func poToVoOffline(message po.Offline) *messagev2.PublishMessage {
	return poToVo(po.Message(message))
}
