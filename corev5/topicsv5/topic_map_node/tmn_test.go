...
func TestSub(t *testing.T) {
	...
	tmnp.Subscribe([]byte("/a/s/v"), "as1", "node1")
	tmnp.Subscribe([]byte("/a/s/v"), "as1", "node1")
	tmnp.Subscribe([]byte("/a/s/v"), "as2", "node1")
	tmnp.Subscribe([]byte("/a/s/v"), "as1", "node2")
	tmnp.Subscribe([]byte("/a/s/v"), "as2", "node2")
	tmnp.Subscribe([]byte("/a/s/v"), "as1", "node2")
	tmnp.Subscribe([]byte("/a/s/v2"), "as1", "node1")
	tmnp.Subscribe([]byte("/a/s/v2"), "as1", "node2")
